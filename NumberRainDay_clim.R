...
dir.create(paste("Data/CPC-UNIFIED/Number_RainDays/Days2_5/",sep = ""),recursive = T,showWarnings = F)
rio::export(MeanNumberDay,paste("Data/CPC-UNIFIED/Number_RainDays/Days2_5/",season,".csv"))
  ...
  jpeg(filename = paste("Products/Number_Rain_Day/Day2_5/",season,".jpeg",sep=""),
       width = 14,
       height =14,
       units = "in",
       res=300)
