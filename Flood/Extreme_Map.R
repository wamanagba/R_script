...
##############################Legend############################################
###Read Data########################
Data<-rio::import(paste("Data/Hazard_95th.csv",sep=""))

Raster_file<-rasterFromXYZ(Data[c("X","Y","Percentile95")])
...
Title<-paste("95th Percentile of daily extreme precipitation over Kaduna","\nRef: 1983-2021","\nData Source: ",Data_Source,sep="")

#Im<-grid::rasterGrob(png::readPNG("Logos/Acmad_logo_1.png"), interpolate = TRUE)

l<-ggplot()+geom_contour_filled(data=Data, aes(x,y,z =Percentile95),breaks= mybreaks, show.legend = TRUE) +
