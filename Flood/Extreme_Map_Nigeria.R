...
mybreaks <- c(200,700,1200,1700,2200,2700,3000,Inf)
...
breaklabel <- function(x){
  labels<-as.character(c(200,700,1200,1700,2200,2700,3000))
...
dir.create(paste("Products/Graphs/Nigeria/",sep=""),recursive = T,showWarnings = F)

jpeg(filename = paste("Products/Graphs/Nigeria/","Rainfall_average_yearly2 ","_",Data_Source,".jpeg",sep=""),
     width = 14,
     height =14,
     units = "in",
     res=300)
...
200,700,1200,1700,2200,2700,3000
