...
for (k in 2015:2021) {
  ...
  Title<-toupper(paste("Number of wet day","\nYear: ", k,"\nData Source: ",Data_Source,sep=""))
  ...
  dir.create(paste("Products/Dry_speel/Afrique/Number_Rain_Day/",season,"/",sep=""),recursive = T,showWarnings = F)
  
  jpeg(filename = paste("Products/Dry_speel/Afrique/Number_Rain_Day/",season,"/",season,"_",k,".jpeg",sep=""),
       width = 14,
       height =14,
       units = "in",
       res=300)
